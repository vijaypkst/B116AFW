...
class LoginPage: #POM class-to store elements & related methods
    ...
    def click_login_button(self):
        self.__driver.find_element(*self.__LN).click()


class Script1: #Test Class--> execution
